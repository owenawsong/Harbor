...
export const BUILT_IN_SKILLS: Skill[] = [
  {
    id: 'compare-prices',
    name: 'Compare Prices',
    description: 'Instantly compare product prices across multiple stores and find the best deal.',
    icon: 'ShoppingCart',
    category: 'shopping',
    isBuiltIn: true,
    isEnabled: true,
...
Be thorough — check at least 5 sources before presenting results.`,
  },
  {
    id: 'deep-research',
    name: 'Deep Research',
    description: 'Comprehensive multi-source research with synthesized insights and citations.',
    icon: 'BookOpen',
    category: 'research',
    isBuiltIn: true,
    isEnabled: true,
...
Be rigorous and comprehensive — quality over speed.`,
  },
  {
    id: 'extract-data',
    name: 'Extract Data',
    description: 'Extract structured data from any web page — tables, lists, prices, contacts.',
    icon: 'Table',
    category: 'data',
    isBuiltIn: true,
    isEnabled: true,
...
Be precise — every data point should be accurate and complete.`,
  },
  {
    id: 'fill-form',
    name: 'Fill Form',
    description: 'Intelligently fill out forms using context from your profile or provided information.',
    icon: 'FileEdit',
...
Be careful — never submit without user confirmation and never guess personal information.`,
  },
  {
    ...
    description: 'Discover better, cheaper, or more ethical alternatives to any product or service.',
    icon: 'Shuffle',
    category: 'shopping',
    isBuiltIn: true,
    isEnabled: true,
...
export const SKILL_CATEGORIES: Record<string, { label: string; color: string }> = {
  research:    { label: 'Research',    color: 'text-purple-600 bg-purple-50 dark:text-purple-300 dark:bg-purple-950/30' },
  productivity:{ label: 'Productivity',color: 'text-blue-600 bg-blue-50 dark:text-blue-300 dark:bg-blue-950/30' },
  data:        { label: 'Data',        color: 'text-green-600 bg-green-50 dark:text-green-300 dark:bg-green-950/30' },
  shopping:    { label: 'Shopping',    color: 'text-orange-600 bg-orange-50 dark:text-orange-300 dark:bg-orange-950/30' },
  navigation:  { label: 'Navigation',  color: 'text-teal-600 bg-teal-50 dark:text-teal-300 dark:bg-teal-950/30' },
  content:     { label: 'Content',     color: 'text-rose-600 bg-rose-50 dark:text-rose-300 dark:bg-rose-950/30' },
  custom:      { label: 'Custom',      color: 'text-gray-600 bg-gray-50 dark:text-gray-300 dark:bg-gray-950/30' },
}
